...
!> Some simple regressions tests checking whether all libwavegrid molorb implementations 
...
module test_libwavegrid_simple
  use fortuno_serial, only : is_close, serial_case_base, suite => serial_suite_item, test_item,&
      & test_list
  use libwavegrid, only : getAtomicDensities, getTotalChrg, getValue, TMolecularOrbital
