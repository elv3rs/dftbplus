...
!> Compatibility shim mapping legacy HSD API patterns to hsd-fortran.
!>
!> This module provides call signatures similar to the legacy hsdutils module
!> but operating on hsd_table (from hsd-fortran) instead of fnode (from xmlf90).
!> It enables incremental conversion of parser files from fnode to hsd_table
...
!>
!> This is a TRANSITIONAL module — it will be simplified once all call sites are
!> converted to direct hsd-fortran API calls.
...
contains
  ...
  !> Get integer child value with default
  ...
  ! ============================================================
  !  getChildValue — rank-1 arrays (required)
  ! ============================================================
  ...
  ! ============================================================
  !  getChildValue — rank-2 arrays (required)
  ! ============================================================
  ...
  subroutine warnUnprocessedNodes(node, tIgnoreUnprocessed)
    ...
    ! No-op: schema_validate_strict or hsd_warn_unprocessed will replace this
