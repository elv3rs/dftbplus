...
#:if WITH_ELSI
  use elsi, only : elsi_dm_complex, elsi_dm_complex_sparse, elsi_dm_real, elsi_dm_real_sparse,&
      ...
      & elsi_set_rw_blacs, elsi_set_rw_csc, elsi_set_rw_mpi, elsi_set_rw_zero_def,&
      & elsi_set_sing_check, elsi_set_sparsity_mask, elsi_set_spin, elsi_set_zero_def,&
      & elsi_write_mat_complex, elsi_write_mat_complex_sparse, elsi_write_mat_real,&
      & elsi_write_mat_real_sparse
#:else
...
end module dftbp_extlibs_elsiiface
